...
class Model(object):
    ...
    #: Support for half-cut (cuts label material but not backing paper).
    #: Available on models with an auto-cutter that supports partial cuts.
...
ALL_MODELS = [
  ...
  Model('QL-800',   (150, 11811), two_color=True, half_cut=True, compression=False, num_invalidate_bytes=400),
  Model('QL-810W',  (150, 11811), two_color=True, half_cut=True, num_invalidate_bytes=400),
  Model('QL-820NWB',(150, 11811), two_color=True, half_cut=True, num_invalidate_bytes=400),
